import TrimForm from "./TrimSimpleFrom";
import { useAppDispatch, useAppSelector } from "../../../store/hooks";
import { updateFieldSP, addGradeSP, removeGradeSP } from "../../../store/slice/createCarSimpleSlice";
...
export default function GradesForm() {
  ...
  const grades = useAppSelector(state => state.createCarSimple.formData.grades);
